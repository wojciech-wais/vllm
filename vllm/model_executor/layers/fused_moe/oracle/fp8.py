...
def select_fp8_moe_backend(
    ...
    # On Hopper (SM 9.0), DeepGEMM is preferred over FlashInfer CUTLASS since
    # FlashInfer CUTLASS kernels are primarily optimized for Blackwell (SM >= 10.0)
    # and are less memory-efficient on Hopper for large token batches.
    # See: https://github.com/vllm-project/vllm/issues/34249
